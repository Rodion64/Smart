    ...
    function add_html(x) {
        ...
        Container_2.insertAdjacentHTML('afterbegin',  `
            <div class="products_main_head_left_box">
                        <a class="products_main_head_left_box_item" href="product_${x}.html">
                        ...
                        <div class="products_main_head_left_box_item">
                            ...
                            <div class="price_icon"  onclick="Basket_1(${x})"> </div>
...
function Bott_1(){
    let answer = localStorage.getItem('b');   
    for (let i = 0; i < h.length; i++){
        answer += ',' + h[i] ;
    }
    localStorage.setItem('b', answer);
    console.log(answer);
